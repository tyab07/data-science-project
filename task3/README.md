...
> [!NOTE]
> The final `improvisation_report.pdf` is automatically generated by `generate_improvisation_report.py` and can be found in the `task3/` directory after execution.
